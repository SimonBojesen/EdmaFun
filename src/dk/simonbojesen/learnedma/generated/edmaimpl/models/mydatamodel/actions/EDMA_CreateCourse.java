package dk.simonbojesen.learnedma.generated.edmaimpl.models.mydatamodel.actions;

import dk.simonbojesen.learnedma.generated.edmaimpl.models.mydatamodel.MyDataModelVUImpl;
    ...
    public boolean execute(IDataModelUpdate edma_dm)
    {
        ...
        switch(e)
        {
            case 0:
                ...
                break;
            case 1:
                edma_userMethod.setErrorCode(1, "Course already exists");
                break;
            default:

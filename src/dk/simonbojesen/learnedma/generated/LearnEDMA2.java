package dk.simonbojesen.learnedma.generated;

import dk.simonbojesen.learnedma.generated.edmaimpl.models.mydatamodel.MyDataModelFactoryImpl;
...
public class LearnEDMA2
{
    ...
    public static IMetaEnvironment generateEnvironment()
    {
        ...
        MetaEnvironment edma_environment = new MetaEnvironment("LearnEDMA2");
        {
            MetaDataModel edma_model = new MetaDataModel("MyDataModel", "LearnEDMA2");
     ...
     */
    public LearnEDMA2(IRuntimeFactory factory)
    {
